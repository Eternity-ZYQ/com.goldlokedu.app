...
teacher_contacts_text=Mobile.getText(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/teacher_contacts_text"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)

 
 "清空手机短信内容"
 Mobile.clearText(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/sms_content_edittext"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 ...
 "设置手机短信内容:系统时间+测试短信"
 Mobile.setText(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/sms_content_edittext"), time1+"测试短信", GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 ...
 "选择是否需要回复"
 Mobile.tap(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/need_reply_option_text"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 Mobile.tap(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/Selection Box/sure_btn"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 
 
 "选择署名"
 Mobile.tap(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/sms_signature_option_text"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 Mobile.tap(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/Selection Box/sure_btn"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
 
 
 "点击发送"
 Mobile.tap(findTestObject("Object Repository/Android/Bottom Bavigation/Campus/Interactive Management/SMS/Sending SMS/sms_send_text"), GlobalVariable.G_Timeout, FailureHandling.CONTINUE_ON_FAILURE)
