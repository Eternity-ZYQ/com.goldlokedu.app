...
'学生筛选时间作业列表接口路径'
def path='Object Repository/Api/Mobile Api/Campus/Homework/student_homework_time_filter_list'
'加载缩略图接口路径'
...
'获取默认学生作业列表'
ResponseObject list_response=WS.sendRequestAndVerify(findTestObject(path, [('from'):from,('size'):size,('from_date'):start_time,('to_date'):end_time]), FailureHandling.CONTINUE_ON_FAILURE)
