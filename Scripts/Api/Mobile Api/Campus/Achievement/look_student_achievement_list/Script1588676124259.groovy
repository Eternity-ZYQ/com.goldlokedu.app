...
if(achieve_jsonResponse.data.records.size>0){
	...
	for(int x:(0..achieve_jsonResponse.data.records.size-1)){
		...
		'进入成绩详情页面'
		WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Mobile Api/Campus/Achievement/look_student_achievement_list', [('exam_id'):exam_id]), FailureHandling.CONTINUE_ON_FAILURE)
