...
if(leave_jsonResponse.data.size>0){
	...
	def refuse_reason=CustomKeywords.'time.SystemTime.get_system_time'()+GlobalVariable.user_name+'驳回了你的请假'
	'第一条待审批操作：驳回'
	WS.sendRequestAndVerify(findTestObject('Object Repository/Api/Mobile Api/Campus/Leave/refuse_leave', [('leave_id'):leave_id,('refuse_reason'):refuse_reason]), FailureHandling.CONTINUE_ON_FAILURE)
