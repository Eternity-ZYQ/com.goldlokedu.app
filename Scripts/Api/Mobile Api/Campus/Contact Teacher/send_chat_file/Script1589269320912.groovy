...
'发送文件消息接口路径'
def path1='Object Repository/Api/Mobile Api/Campus/Contact Teacher/send_chat_file'
'获取最新消息接口路径'
def path2='Object Repository/Api/Mobile Api/Campus/Contact Teacher/poll_new_chat_record'
'上传文件接口路径'
def path3='Object Repository/Api/Mobile Api/Campus/Contact Teacher/upload_file'
...
if(WS.containsString(teacher_msg_response, 'user_id', false, FailureHandling.OPTIONAL)){
	...
	'上传文件'
	ResponseObject upload_response=WS.sendRequestAndVerify(findTestObject(path3), FailureHandling.CONTINUE_ON_FAILURE)
