...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.MobileHost}/content/front/gaokao/bySubject?degree=本科&amp;from=0&amp;school_code_or_name=${GlobalVariable.college_school_code}&amp;size=50</restUrl>
