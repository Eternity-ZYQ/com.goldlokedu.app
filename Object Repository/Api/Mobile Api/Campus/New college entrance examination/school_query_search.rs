...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.MobileHost}/content/front/gaokao/bySubject?from=0&amp;major_name=计算机类&amp;school_code_or_name=${GlobalVariable.college_school_code}&amp;size=50</restUrl>
