...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.MobileHost}/attendance/general/record/month_simple_statics_about_klass?check_month=2020-03-26&amp;klass_id=${GlobalVariable.class_id}</restUrl>
