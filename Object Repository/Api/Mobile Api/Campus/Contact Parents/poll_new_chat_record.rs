...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.MobileHost}/homeschool_chat/teacher_parent/app/poll?counter=${GlobalVariable.next_poll_counter}&amp;target_id=${GlobalVariable.student_id}</restUrl>
