...
<WebServiceRequestEntity>
   <description>打电话搜索教师手机号</description>
   <name>search_contact_teacher_mobile</name>
   <tag></tag>
   <elementGuidId>35f5acf4-3ac7-4afb-8338-157fedc9ec4e</elementGuidId>
   ...
   <restUrl>${GlobalVariable.MobileHost}/user_profile/api/upf/contact/name/contact_information?id=${GlobalVariable.user_school_id}&amp;name=${teacher_mobile}&amp;type=app</restUrl>
