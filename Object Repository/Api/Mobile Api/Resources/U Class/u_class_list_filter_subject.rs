...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.MobileHost}/onlineclass/detailpage/search_course?from=0&amp;popularity_sort=desc&amp;size=10&amp;subject_code=${GlobalVariable.u_class_filter_subject_code}</restUrl>
